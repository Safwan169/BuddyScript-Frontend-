...
const MiddleLayout = () => {
  ...
  "id": 101,
  "userName": "Karim Saif",
  "userProfileImage": "assets/images/post_img.png",
  "timeAgo": "5 minute ago",
  "postVisibility": "Public",
  "postTitle": "New update for the -Healthy Tracking App. Check out the latest features in version 2.0!",
  ...
  "recentComment": {
    "commenterName": "Radovan SkillArena",
    "commenterImage": "assets/images/txt_img.png",
    "commentText": "It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. This is fantastic!",
    "commentTime": "21m",
    "totalLikes": 198
  }
};
          ...
          <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12">
            <div className="_layout_middle_wrap">
             ...
             {/* for send a post  */}
                ...
                {/* post card  */}
                <PostComponent  postData={mockPostData}/>
