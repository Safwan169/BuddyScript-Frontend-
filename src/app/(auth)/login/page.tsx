                                    ...
                                    <div className="row">
                                        <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                            <div className="_social_login_form_input _mar_b14">
                                                <label className='_social_login_label _mar_b8' htmlFor="">Email</label>
                                    ...
                                    <div className="row">
                                        <div className="col-lg-6 col-xl-6 col-md-6 col-sm-12">
                                            <div className="form-check _social_login_form_check">
                                                <input type="radio" className='form-check-input _social_login_form_check_input' name='flexRadioDefault' id='flexRadioDefault2' checked />
                                    ...
                                    <div className="row">
                                        <div className=" col-lg-12 col-md-12 col-xl-12 col-sm-12">
                                            <div className="_social_login_form_btn _mar_t40 _mar_b60 ">
                                                <button type='button' className='_social_login_form_btn_link _btn1 _btn2 '>Login now</button>
                                            </div>
                                        </div>
                                    </div>
